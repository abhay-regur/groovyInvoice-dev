                ...
                <div className="container-fluid">
                    ...
                    <div className={`${styles.companyInvoiceTopInvoiceHeader} card`}>
                        <div className={`${styles.card_body} card-body row`}>
                            ...
                            <div className={`${styles.companyInvoiceTopHeaderTotalOutstandingWrapper} col-6 col-lg-3`}><div className="row"><div className={`${styles.companyInvoiceTopHeaderSVGWrapper} col-12 col-lg-2 d-none d-lg-flex justify-content-lg-start align-items-center`}><i><FaRupeeCircle /></i></div><div className="col-12 col-lg-10"><div className={`${styles.companyInvoiceTopInvoiceHeaderText}`}>Total Outstanding Receivables</div><div className={`${styles.companyInvoiceTopInvoiceHeaderNumber}`}>Rs. {totalOutstandingReceivables}</div></div></div></div>
