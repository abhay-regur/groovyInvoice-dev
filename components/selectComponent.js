const SelectOptionComponent = ({ id, data, setSeletedId, seletedId, name, isDisabled, defaultText }) => {
    if (data != undefined) {
        return (
            <select id={id} className="form-select" name={name} value={seletedId} onChange={setSeletedId} disabled={isDisabled}>
