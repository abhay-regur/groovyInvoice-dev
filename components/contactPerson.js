    ...
    const removeContactPersonEntry = async (id) => {
        try {
            ...
            if (results.status == 200 || results.status == 201) {
                setToastList([{
                    id: Math.floor((Math.random() * 101) + 1),
                    title: 'Contact Person is removed',
                    description: '',
                }]);
            }
        } catch (error) {
                                        ...
                                        <tr key={idx} className={`${tableStyles.companyInvoiceContactPersonRow}`}>
                                            ...
                                            <td className={`${tableStyles.companyInvoiceContantPersonEditRow}`}>
                                                <div className="d-flex">
                                                    <span onClick={() => { showModal(item.id) }}><FaCilcleEllipses /></span>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className={`${styles.companyInvoiceNameWrapper} mb-0 mb-md-4 row`}>
                                ...
                                <div className="col-12 col-lg-6 col-xl-6">
                                    <input type="text" name='firstName' className={`${styles.companyInvoiceNewCustomerFirstName} form-control`} value={newPerson.firstName} onChange={handleInput} placeholder='First Name' />
                                </div>
                            </div>
                            ...
                            <div className={`${styles.companyInvoiceNameWrapper} mb-0 mb-md-4 row`}>
                                ...
                                <div className="col-12 col-lg-6 col-xl-6">
                                    <input type="text" name='lastName' className={`${styles.companyInvoiceNewCustomerLastName} form-control`} value={newPerson.lastName} onChange={handleInput} placeholder='Last Name' />
                                </div>
                            </div>
                            ...
                            <div className={`${styles.companyInvoiceCompanyEmailWrapper} mb-4 row`}>
                                ...
                                <div className="col-12 col-lg-6 col-xl-6 d-flex align-items-center">
                                    <input name='email' type="email" className="form-control" id="companyInvoiceCompanyEmail" value={newPerson.email} placeholder='Company Email' onChange={handleInput} />
                                </div>
                            </div>
                            ...
                            <div className={`${styles.companyInvoiceCompanyPhone} mb-4 row`}>
                                ...
                                <div className="col-12 col-lg-6 col-xl-6 d-flex align-items-center">
                                    <input name='phone' type="tel" className={`${styles.companyInvoiceCompanyWorkPhone} form-control`} value={newPerson.phone} placeholder='Work Phone' onChange={handleInput} />
                                </div>
                            </div>
                            <div className={`${styles.companyInvoiceCompanyPhone} mb-4 row`}>
                                <div className="d-flex align-items-center col-12 col-lg-4 col-xl-3">
                                ...
                                <div className="col-12 col-lg-6 col-xl-6 d-flex align-items-center">
                                    <input name='cellNumber' type="tel" className={`${styles.companyInvoiceCompanyMobile} form-control`} value={newPerson.cellNumber} placeholder='Mobile' onChange={handleInput} />
                                </div>
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className={`${styles.companyInvoiceSaveSendButton} btn blue`}>
                                <span>
                                    <i><FaSave /></i>
                                    Update
                                </span>
